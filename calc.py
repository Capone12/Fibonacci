...
def opreracion():
    ...
    resulatado = eval(ecuacion)
    e_texto.delete(0, END)
    e_texto.insert(0, resulatado)
    i = 0
...
boton_resul = Button(ventana, text = "=", width = 5, height = 2, command = lambda: opreracion())

#imprimir botones por pantalla
...
boton_resul.grid(row = 5, column = 3, padx = 5, pady = 5)
